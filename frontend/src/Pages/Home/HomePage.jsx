import { Box, Heading, Text, Highlight, Button, Stack, Input, Flex, SimpleGrid, Icon, Container } from "@chakra-ui/react";
import { Ghost, Search, Users, BookOpen, Award, Clock } from "lucide-react";
...
export default function HomePage() {
  ...
  const cardBg = useColorModeValue("blackAlpha.300", "whiteAlpha.100");
  const cardBorder = useColorModeValue("teal.200", "whiteAlpha.200");
  const grayShades = useColorModeValue("gray.700", "gray.400");
  ...
  return (
    <Box left="0" w="100%" overflowX="hidden" >
      ...
      <Box mt={16}>
        ...
        <Box mt={10} ml="5%" p="2%" w={["85%", "80%", "60%", "95%"]} rounded="md" >
          ...
          <Text fontSize="2xl" mb={8} color="fg.muted" w={["100%", "100%", "100%", "95%"]}>
          ...
          >
            <Stack direction={{ base: "column", md: "row" }} spacing="26px" align="center" mb={6}>
              ...
              <Button
                ...
                bg={altButtonBg}
                color={altTxtColor}
                _hover={{ bg: altHoverBg, color: altHoverColor, transform: "translateY(-2px)", shadow: "lg" }}
                transition="all 0.2s"
              ...
              <SimpleGrid columns={{ base: 2, md: 3, lg: 6 }} gap="10px">
                {branches.map((branch) => (
                  <Box
                    ...
                    as="button"
                    p="10px"
                    bg={useColorModeValue("teal.200", "whiteAlpha.100")}
        ...
        <Box mt={16} w="100%" overflow="hidden">
          <Heading size="2xl" mb={8} ml="5%" color={hoverColor}>Explore Categories</Heading>
              ...
              {[
                ...
                >
                  <Box
                    ...
                    transition="opacity 0.3s"
                  />
                  <Icon as={feature.icon} w={12} h={12} color={boxBg} mb={6} bg={hoverColor} p={3} rounded="xl" />
                  <Heading color={hoverColor} size="md" mb={4}>{feature.title}</Heading>
                  <Text color={txtColor}>{feature.desc}</Text>
                </MotionBox>
              ))}
            </SimpleGrid>
          </Container>
            ...
            {[
              ...
              >
                ...
                <Box p={6}>
                  ...
                  <Heading color={hoverColor} size="md" mb={3}>{course.title}</Heading>
                  <Text color={txtColor} fontSize="sm" mb={6}>{course.desc}</Text>
                  <Flex justify="space-between" align="center" pt={4} borderTopWidth="1px" borderColor={txtColor}>
                    <Text fontSize="xs" color={grayShades}>{course.level}</Text>
                    <Box
                      w={8}
                      h={8}
                      bg={altHoverBg}
        ...
        <Box bg={cardBg} mt={20} mb={20} mx="auto" p={8} w={["90%", "80%", "60%"]} rounded="2xl" shadow="lg" textAlign="center">
          ...
          <Button
            ...
            bg={buttonBg}
            color={txtColor}
            _hover={{ bg: HoverBg, color: hoverColor, transform: "translateY(-2px)", shadow: "xl" }}
            size="lg"
            rounded="full"
            px={10}
          >
