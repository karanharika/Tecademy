...
export default function Dashboard() {
  ...
  async function handleCreateSession() {
    let formatdate = `${newSession.date}T${newSession.time}:00.000+05:30`
    try {
    ...
    <Box minH="100vh" bg={bgColor} position="relative" overflowX="hidden">
      ...
      <Box position="relative" zIndex={1} maxW="7xl" mx="auto" px={{ base: 4, md: 8 }} py={{ base: 8, md: 8 }} pt={{ base: 24, md: 28 }}>
        ...
        <Flex justify="space-between" align="center" mb={10} bg={glassBg} backdropFilter="blur(10px)" p={4} rounded="2xl" shadow="sm" borderWidth="1px" borderColor={borderColor}>
          <Heading size="2xl" bgGradient="linear(to-r, pink.500, purple.500, teal.400)" fontFamily="" letterSpacing="wider">
            Dashboard
          </Heading>
          ...
          <HStack spacing={4}>
            <HStack bg={useColorModeValue("white", "gray.800")} px={4} py={2} rounded="full" shadow="sm" borderWidth="1px" borderColor={borderColor}>
              ...
              <Text fontSize="sm" color="gray.500">{dbuser.tokens} Tokens</Text>
            </HStack>
        ...
        <Flex justify="center" mb={10}>
          <Box bg={glassBg} p={1} rounded="full" shadow="md" borderWidth="1px" borderColor={borderColor}>
            <HStack spacing={0}>
              {['student', 'teaching'].map((mode) => (
                <Box key={mode} position="relative">
                  ...
                  <Button
                    ...
                    fontSize="md"
                    fontWeight="bold"
                    color={viewMode === mode ? "teal.700" : "gray.500"}
                    _hover={{ color: viewMode === mode ? "teal.600" : "teal.500" }}
                    position="relative"
                    zIndex={1}
                  >
